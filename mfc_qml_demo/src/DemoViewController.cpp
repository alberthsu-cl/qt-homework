...
void CDemoViewController::WireButtons(IQmlContext* pContext)
{
    ...
    struct { const char* name; QmlClick code; Action fn; } kButtons[] = {
        { DemoName.zoomInButton,  kClickZoomIn,  &CDemoController::ZoomIn    },
        { DemoName.zoomOutButton, kClickZoomOut, &CDemoController::ZoomOut   },
        { DemoName.rotateButton,  kClickRotate,  &CDemoController::Rotate90  },
        { DemoName.resetButton,   kClickReset,   &CDemoController::ResetView },
    };
